...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<?=BASE_URL?>/assets/css/peminjaman.css"  />
...
<div class="container-fluid h-100">
    <div class="row">
        ...
        <div class="col-lg-10 container">
            ...
            <div class="row">
                <div class="col bg-content scroll scroll3">
                    <?php $this->content('content-peminjaman'); ?>
                </div>
            </div>
