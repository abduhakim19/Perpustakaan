<html>
    ...
    <div class="card mb-5">
        <div class="card-body pl-4 pt-4 pb-4 pr-4">
            <div class="row">
                <div class="col mb-4">
                    <button type="button" class="btn bg-btn-tambah btn-md float-left">Tambah Kategori</button>
                </div>
            </div>
    ...
    <script src="<?=BASE_URL?>/assets/js/content/content-kategori-buku.js"></script>
