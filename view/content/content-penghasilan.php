<html>
    ...
    <div class="card mb-5">
        <div class="card-body pl-4 pt-4 pb-4 pr-4">
            <div class="row">
                <div class="col mb-4">
                    <button type="button" class="btn btn-primary btn-tambah btn-md float-left">Tambah Penghasilan</button>
                </div>
            </div>
            <div class="table-responsive pr-0 pl-0">
                    <table id="tablekategori" class="table table-striped table-data display w-100" style="font-size: 14px;">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">ID Penghasilan</th>
    ...
    <script src="<?=BASE_URL?>/assets/js/content/content-penghasilan.js"></script>
